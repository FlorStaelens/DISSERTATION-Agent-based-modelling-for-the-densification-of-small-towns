class Perceel {
  ...
  Perceel(int NUMMER, float OPPPERC, float HOOG, float OPPBEB, float MOBI, String VERNIEUWG, String WOONG, String LANDB, String BEDRIJVENT, String UITBR, int ZONEID, String ZONE, Float X, Float Y ) {
    shapeid = NUMMER;
    i = NUMMER;
    oppPerceel = OPPPERC;
    hoogte =HOOG;
...
//________________________________________update probability____________________________________________//
  ...
  void tekenPunten() {
    ...
    textSize(1);
    text(hoogte, zwaartepunt.x, zwaartepunt.y);
  }
}
